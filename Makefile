...
all:
	g++ -I src/include -L src/lib -o main main.cpp game/graphic_game/cpp_files/Window.cpp  game/logic_game/cpp_files/GameObject.cpp game/logic_game/cpp_files/Car.cpp game/Grid.cpp -lmingw32 -lSDL2main -lSDL2 -lSDL2_ttf 