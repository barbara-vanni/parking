...
all:
	g++ -I src/include -L src/lib -o main main.cpp game/graphic_game/cpp_files/Window.cpp game/graphic_game/cpp_files/graphicInit.cpp game/Grid.cpp game/gameLoop.cpp game/graphic_game/cpp_files/Button.cpp -lmingw32 -lSDL2main -lSDL2 -lSDL2_ttf 